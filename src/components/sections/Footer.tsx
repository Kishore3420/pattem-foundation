    ...
    <footer className="bg-gray-900 text-white">
      <div className="mx-auto max-w-7xl px-6 py-12 lg:px-8">
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
          <div>
            ...
            <p className="mt-4 text-sm text-gray-300">
              We are dedicated to creating positive change through sustainable development,
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              ...
              <li>
                <Link href="/causes" className="text-sm text-gray-300 hover:text-white">
                  Our Causes
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2 text-sm text-gray-300">
              <li>123 Foundation Street</li>
              <li>City, State 12345</li>
              <li>Phone: (123) 456-7890</li>
              <li>Email: info@pattemfoundation.org</li>
            </ul>
          </div>
          <div>
        ...
        <div className="mt-8 border-t border-gray-700 pt-8 text-center text-sm text-gray-300">
          <p>&copy; {new Date().getFullYear()} Pattem Foundation. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
